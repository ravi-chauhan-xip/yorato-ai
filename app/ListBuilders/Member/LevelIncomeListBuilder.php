...
class LevelIncomeListBuilder extends ListBuilder
{
    public static string $name = 'Level Income';

    public static function query(array $extras = [], ?Request $request = null): Builder
    {
        $query = LevelIncome::with('member.user', 'fromMember.user')->where('member_id', $extras['member_id']);
