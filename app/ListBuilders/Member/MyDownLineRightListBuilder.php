...
class MyDownLineRightListBuilder extends ListBuilder
{
    public static string $name = 'My Right Downline';
    ...
    public static function columns(): array
    {
        return [
            ...
            new ListBuilderColumn(
                name: 'Parent Wallet Address',
                property: 'parent.user.wallet_address',
                filterType: ListBuilderColumn::TYPE_TEXT,
                viewCallback: function ($model) {
                    return view('admin.web3-address', [
                        'address' => $model->parent->user->wallet_address,
                    ]);
                }),
            new ListBuilderColumn(
                name: 'Status',
