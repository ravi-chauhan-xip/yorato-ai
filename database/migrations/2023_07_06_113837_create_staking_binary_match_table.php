...
class CreateStakingBinaryMatchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('staking_binary_matches', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('staking_binary_matches');
    }
}
