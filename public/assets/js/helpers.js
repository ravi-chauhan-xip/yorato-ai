    ...
    return function () {
        ...
        var d = {
            ...
            _scrollToActive: function () {
                ...
                if (n) {
                    ...
                    if (i) {
                        ...
                        var r = o.scrollTop, s = i - r - parseInt(o.clientHeight / 2, 10), a = +new Date;
                        !0 === t ? function t() {
                            var n, i, l, u = +new Date - a,
                                c = (n = u, i = r, l = s, (n /= e / 2) < 1 ? l / 2 * n * n + i : -l / 2 * ((n -= 1) * (n - 2) - 1) + i);
                            o.scrollTop = c, u < e ? requestAnimationFrame(t) : o.scrollTop = s
                        }() : o.scrollTop = s
                    }
                }
            },
            ...
            scrollPageTo: function (t) {
                ...
                "string" == typeof t && (t = document.querySelector(t)), "number" != typeof t && (t = t.getBoundingClientRect().top + n.scrollTop);
                var i = n.scrollTop, o = t - i, r = +new Date;
                !function s() {
                    var a, l, u, c = +new Date - r,
                        d = (a = c, l = i, u = o, (a /= e / 2) < 1 ? u / 2 * a * a + l : -u / 2 * ((a -= 1) * (a - 2) - 1) + l);
                    n.scrollTop = d, c < e ? requestAnimationFrame(s) : n.scrollTop = t
                }()
            },
            setCollapsed: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("collapsed"),
                    n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                this.getLayoutMenu() && (this._unbindLayoutAnimationEndEvent(), n && this._supportsTransitionEnd() ? (this._addClass("layout-transitioning"), e && this._setMenuHoverState(!1), this._bindLayoutAnimationEndEvent((function () {
                    t._setCollapsed(e)
                }), (function () {
            ...
            setAutoUpdate: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("enable");
            ...
            on: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("event"),
                    ...
                    o = i(t.split("."), 1)[0], r = n(t.split(".")).slice(1);
                r = r.join(".") || null, this._listeners.push({event: o, namespace: r, callback: e})
            },
            off: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("event"),
                    o = i(e.split("."), 1)[0], r = n(e.split(".")).slice(1);
            ...
            navTabsAnimation: function () {
                document.querySelectorAll(".nav-tabs").forEach((function (t) {
                    var e = t.querySelector(".tab-slider");
                    if (!e) {
                        var n = document.createElement("span");
                        n.setAttribute("class", "tab-slider"), e = t.appendChild(n)
                    }
                    var i = t.closest(".nav-align-left") || t.closest(".nav-align-right"), o = function (n) {
                        var o = n.parentElement.getBoundingClientRect(), r = n.getBoundingClientRect(), s = r.x - o.x,
                            a = t.closest(".nav-align-bottom");
                        i ? (e.style.top = r.y - o.y + "px", e.style[t.closest(".nav-align-right") ? "inset-inline-start" : "inset-inline-end"] = 0, e.style.height = r.height + "px") : (e.style.left = s + "px", e.style.width = r.width + "px", a || (e.style.bottom = 0))
                    };
                    t.addEventListener("click", (function (t) {
                        t.target.closest(".nav-item .active") && o(t.target.closest(".nav-item"))
                    })), o(t.querySelector(".nav-link.active").closest(".nav-item"))
                }))
            },
        ...
        return "undefined" != typeof window && (d.init(), d.isMobileDevice() && window.chrome && document.documentElement.classList.add("layout-menu-100vh"), "complete" === document.readyState ? d.update() : document.addEventListener("DOMContentLoaded", (function t() {
            d.update(), document.removeEventListener("DOMContentLoaded", t)
        }))), e
    }()
}));
