    ...
    return function () {
        ...
        return function () {
            ...
            var b = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
                ...
                z = "rtl" === document.documentElement.getAttribute("dir"), F = !!x.contains("layout-menu-collapsed"),
                k = !!x.contains("layout-menu-flipped"), C = !!x.contains("layout-navbar-fixed"),
                ...
                E = function () {
                        ...
                        key: "setTheme", value: function (t) {
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                if (i) {
                                    ...
                                    this._loadStylesheets((o = {}, a = l, n = document.querySelector(".template-customizer-theme-css"), (a = v(a)) in o ? Object.defineProperty(o, a, {
                                        value: n,
                                        enumerable: !0,
                                        configurable: !0,
                                        writable: !0
                        ...
                        key: "_setup", value: function () {
                            ...
                            if (this._hasControls("layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover", !0)) {
                                ...
                                if (this._controls.layoutNavbarFixedW = this.container.querySelector(".template-customizer-layoutNavbarFixed"), this._hasControls("layoutNavbarFixed")) {
                                    ...
                                    this._controls.layoutNavbarFixed.addEventListener("change", x), this._listeners.push([this._controls.layoutNavbarFixed, "change", x])
                                ...
                                if (this._controls.layoutFooterFixedW = this.container.querySelector(".template-customizer-layoutFooterFixed"), this._hasControls("layoutFooterFixed")) {
                                    ...
                                    this._controls.layoutFooterFixed.addEventListener("change", w), this._listeners.push([this._controls.layoutFooterFixed, "change", w])
                    ...
                    }], s && g(e.prototype, s), Object.defineProperty(e, "prototype", {writable: !1}), t
                }();
